	...
	<body>
		<div id='page' data-role='page'>
				...
				<div id="wrapper">
					<div class="slider-wrapper theme-default">
						<div id="slider" class="nivoSlider" style="height: auto;">
							<img src="../images/splash.jpg" data-thumb="../images/splash.jpg" alt="" style="width: 450px;visibility: hidden; display: inline; max-height: 300px;"/>
							...
							<img src="../images/splash.jpg" data-thumb="../images/splash.jpg" alt="" data-transition="slideInLeft" style="width: 450px;visibility: hidden; display: inline; max-height: 300px;"/>
						</div>
					</div>
				</div>
				<!-- END OF IMAGE SLIDER -->
			...
			<p>
					...
					<div  style='text-align:right; font-family: "Times New Roman", Times, serif; font-weight:;font-size: 10px;padding-right:90px; padding-left:10px; text-align: left;'>
						&copy; 2013 UBA. copyright 2013 UBA. All Rights reserved. United Bank for Africa registration number:194273566352.
			...
			<div id="lower">
				<p id="exTerm" style="border: 2px solid silver; opacity: .95; padding: 15px;background: url('../images/footer.png');
				...
				background-size: 300%; color: white; display: none;">
					As the Corporate Social Responsibility arm of the UT Bank, UT Bank Foundation is committed to the
				...
				<p id="exAbout" style="border: 2px solid silver; opacity: .95; padding: 15px;background: url('../images/footer.png');
				background-repeat: no-repeat;font-family: Arial, Helvetica, sans-serif;font-size: 10px;
				background-size: 300%; color: white; display: none;">
					The UT Bank mobile banker application is meant to provide clients of UT Bank with most of the basic services offered by the bank
					through hand held devices. This service is provided by UT Bank and powered by NALO SOLUTIONS.
				</p>
